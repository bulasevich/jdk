 ...
 *          BCI_B null_check.  The nmethod stays valid and every subsequent null dereference
 *          at BCI_B deoptimizes from the same compiled frame — the storm.
 *          The fix generates an inline throw at BCI_B instead of an Action_none uncommon trap.
 * @library /test/lib
 *
...
public class DeoptStormNullCheckPath3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] procArgs = {
            ...
            "-XX:CompileOnly=compiler.uncommontrap.DeoptStormNullCheckPath3::*",
        ...
        long deoptCount = lines.stream()
            .filter(l -> l.contains(DEOPT_TAG) && l.contains("deoptStorm3") && l.contains("null_check"))
            .count();
    ...
    public void run() {
        ...
        // Without the fix: BCI_B gets Action_none; with the fix: BCI_B gets inline throw.
        for (int i = 0; i < 100_000; i++) {
            deoptStorm3();
        }
        ...
        // With fix: inline throw, no deoptimization.
        b = null;
